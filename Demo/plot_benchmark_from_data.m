function plot_benchmark_from_data(use_real,n,p,SNR,rounds)
if use_real
...
for i=1:len
    ...
    times = 0;
    for round = 1:rounds
        [Dists{round},time] = get_single_data(use_real,n,p,SNR,round,i,0);
        times = times + time;
    end
...
algorithms = ["LS-PGD","LUD-PGD","LUD-IRLS","ReSync"];
hold off
set(gcf, 'Color', 'white');
...
fig_filename = strrep('plot/plot_benchmarks/my_fig.fig','my_fig',exp_name);
